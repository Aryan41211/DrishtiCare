...
%           .thresholdDocumentation - Detailed threshold derivation
    ...
    % Brightness documentation (values match operative config.thresholds)
    config.thresholdDocumentation.brightness = struct(...
        ...
        'poorWhen', 'Too dark (<0.19) or too bright (>0.52)', ...
        'day3Stats', struct('min', 0.2165, 'P5', 0.294, 'P25', 0.361, ...
                           'P50', 0.402, 'P75', 0.428, 'P95', 0.451, 'max', 0.4644), ...
        'thresholdRationale', 'FAIL bounds set from Day 3 percentile analysis of 3,662 images; final threshold values in config.thresholds are the authoritative gate', ...
        'lowerFail', 0.1901, ...
        'lowerWarn', 0.2145, ...
        'upperWarn', 0.4586, ...
        'upperFail', 0.5154);

    % Contrast documentation (values match operative config.thresholds)
    config.thresholdDocumentation.contrast = struct(...
        ...
        'poorWhen', 'Very low contrast (<0.03) indicates washed-out images', ...
        'day3Stats', struct('min', 0.0342, 'P5', 0.044, 'P25', 0.055, ...
    ...
    % Focus documentation (values match operative config.thresholds)
    config.thresholdDocumentation.focus = struct(...
        ...
        'poorWhen', 'Very low focus (<1.4e-4) indicates significant blur', ...
        'day3Stats', struct('min', 2.16e-4, 'P5', 3.50e-4, 'P25', 5.52e-4, ...
    ...
    % Foreground fraction documentation (values match operative config.thresholds)
    config.thresholdDocumentation.foreground = struct(...
        ...
        'poorWhen', 'Very low foreground (<0.27) means image is mostly black border', ...
        'day3Stats', struct('min', 0.474, 'P5', 0.474, 'P25', 0.474, ...
    ...
    % Illumination documentation (values match operative config.thresholds)
    config.thresholdDocumentation.illumination = struct(...
        ...
        'poorWhen', 'Extreme values (<0.80 or >1.35) indicate severe lighting issues', ...
        'day3Stats', struct('min', 0.757, 'P5', 0.95, 'P25', 1.06, ...
